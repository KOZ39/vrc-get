...
## [Unreleased]
### Added
- Project launch buttons now show when Unity is opening or running and can bring open Unity Editor windows to the foreground on Windows. [`#2419`](https://github.com/vrc-get/vrc-get/issues/2419)
